...
<head>
    ...
    <link href="<?php echo site_url('app/core/error/dberror/css/style.css');
...
<script type="text/javascript" src="<?php echo site_url('app/core/error/dberror/js/TweenMax.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url('app/core/error/dberror/js/plugins.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url('app/core/error/dberror/js/actions.js'); ?>"></script>
</body>
</html>
